...
export function ContactsPage() {
  ...
  return (
    <div className="page contacts-page">
      <header className="directory-page-header"><div><span className="eyebrow">Direktori calon jamaah</span><h1>Kontak</h1><p>Seluruh calon jamaah dari percakapan brand aktif, siap ditindaklanjuti oleh tim.</p></div><div><span className="directory-page-header__count">{leads.data.length} kontak</span><button className="button button--primary" onClick={() => navigate('/conversations')}>Buka inbox</button></div></header>
